...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Trade Journal — יומן מסחר פיוצ׳רס" },
      { name: "twitter:title", content: "Trade Journal — יומן מסחר פיוצ׳רס" },
      { property: "og:description", content: "יומן מסחר אישי לפיוצ׳רס: תיעוד עסקאות, סיכום יומי, ייצוא ל-ChatGPT." },
      { name: "twitter:description", content: "יומן מסחר אישי לפיוצ׳רס: תיעוד עסקאות, סיכום יומי, ייצוא ל-ChatGPT." },
